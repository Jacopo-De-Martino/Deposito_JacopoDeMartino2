...
public class ProvaString {
        public static void main(String[] args) {
                ...
                System.out.println(
                                "La lunghezza della Stringa provaStringa :" + provaStringa + " è " + lunghezzaString);

                // ! Utilizziamo le fuzioni toUpperCase() e toLowerCase().

                System.out.println(
                                "Strampo la mia Stringa dopo aver richiamato il metodo toUpperCase "
                                                + provaStringa.toUpperCase());

                System.out.println(
                                "Strampo la mia Stringa dopo aver richiamato il metodo toLoweCase "
                                                + provaStringa.toLowerCase());
                ...
                System.out.println(
                                "La prima lette 'b' della substring bella si trova in indice : "
                                                + provaStringa.indexOf("bella"));
                ...
                System.out
                                .println("Stampa della Stringa utilizzando l'operatore di concatenazione : " + firstPart
                                                + secondPart);
