Package in cui giochiamo con la Classe System(CLASSE FORNITA DA JAVA) .out(CAMPO STATICO CLASSE SYSTEM) in particolare print() e println() (METODI CLASSE SYSTEM.OUT)
